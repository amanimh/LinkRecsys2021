...
//$.notify({
	...
	//title: 'Streamlink Talents',
	//message: 'Bienvenue au monde des talents streamlink',
//},{
	//type: 'info',
	//placement: {
		//from: "bottom",
...
// JQVmap
		...
		var getData=$.get('/Chart/Pays')
		getData.done(function(pays){
...
//var window.ctx = document.getElementById('statisticsChart').getContext('2d');
